...
class _SecurityDashboardState extends State<SecurityDashboard>
  ...
  // Handles both ROOTED_DEVICE and INVALID_SIGNATURE verdicts
  void _showThreatAlert(Map<String, dynamic> result) {
    ...
    switch (verdict) {
      ...
      default:
        ...
        alertMessage = result['message']?.toString() ?? 'Unknown threat detected.';
    ...
    showGeneralDialog(
      ...
      transitionBuilder: (ctx, a1, a2, child) =>
          FadeTransition(opacity: a1, child: ScaleTransition(scale: a1, child: child)),
      pageBuilder: (ctx, _, __) => _ThreatAlert(
        title: alertTitle,
          ...
          AnimatedBuilder(
            ...
            builder: (_, __) => Container(
              ...
              decoration: BoxDecoration(
                ...
                border: Border.all(
                    color: const Color(0xFF00FFA3).withOpacity(0.3 * _glow.value),
                    width: 1.5),
              ),
              child: Icon(Icons.shield_rounded,
                  color: Color.lerp(const Color(0xFF00FFA3).withOpacity(0.5),
                      const Color(0xFF00FFA3), _glow.value),
                  size: 24),
            ),
          ),
            ...
            child: Column(crossAxisAlignment: CrossAxisAlignment.start, children: [
              ...
              Text(
                  ['CRYPTO GATEKEEPER • SIGNATURE RADAR',
                   ...
                   'THREAT SHIELD • BLOCK OVERLAY'][_tab],
                  style: TextStyle(
    ...
    return GestureDetector(
      ...
      child: AnimatedContainer(
        ...
        decoration: BoxDecoration(
          ...
          color: sel ? const Color(0xFF00FFA3).withOpacity(0.1) : Colors.transparent,
          border: sel
          ...
          decoration: BoxDecoration(
            gradient: LinearGradient(
              ...
              colors: [
                ...
                Color.lerp(const Color(0xFF4D0000),
                    const Color(0xFF990000), _pulseAnim.value)!,
